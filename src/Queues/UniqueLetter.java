...
you jot down the very first letter that's only been called out once. If all letters have been repeated, you write "#".
Here's a scenario:
    ...
    public static String findUnique(String A) {
        ...
        for (int i = 0; i < A.length(); i++) {
            ...
            if(hm.get(ch) == 1){
                ...
                while (!q.isEmpty() && hm.get(q.peekFirst()) > 1) {
                    q.pollFirst();
                }
            }
